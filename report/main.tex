...
A implementação do sistema de gestão da EcoRide Solutions envolveu um conjunto de recursos humanos e materiais fundamentais para o seu desenvolvimento e operacionalização.

Do ponto de vista dos recursos humanos, participaram no projeto tanto elementos internos da empresa como uma equipa externa de desenvolvimento. O pessoal interno foi constituído pelos dois gerentes, os quatro mecânicos, o gestor de armazém e a assistente administrativa, todos com funções distintas no contexto da utilização do sistema. A equipa de desenvolvimento, responsável por todas as fases do ciclo de vida do software, integrou Duarte Escairo, Eduardo Fernandes, Inês Ferreira, Luís Soares e Tiago Figueiredo.

Relativamente aos recursos materiais, foram utilizados componentes de hardware e software adequados às exigências do projeto. No que respeita ao hardware, recorreu-se a um servidor de base de dados para alojamento centralizado da informação e aos computadores utilizados pela equipa de desenvolvimento para suporte às atividades de engenharia de software. Em termos de software, foram utilizados o sistema de gestão de base de dados MySQL, o MySQL Workbench para administração e modelação da base de dados, o brModelo para a modelação conceptual do modelo de dados e o Visual Paradigm para a modelação de processos e estruturas com base na linguagem UML. Para além destas ferramentas, foram ainda empregues diversas soluções de apoio ao desenvolvimento, coordenação e teste de código, utilizadas ao longo de todo o ciclo de vida do sistema, sendo a implementação realizada em Java.
...
\begin{tcolorbox}[
	...
	\begin{tcolorbox}[
		...
		Tem em conta que os recursos humanos incluem todo o pessoal interno (da empresa) e pessoal externo (a equipa de desenvolvimento: Duarte Escairo, Eduardo Fernandes, Inês Ferreira, Luís Soares e Tiago Figueiredo) enquanto que os recursos materiais incluem o hardware (servidor bd e os computadores da equipa de desenvolvimento) e o software (sistema de gestão de bd, neste caso o MySQL, Workbench, o brModelo, para modelação conceptual da BD e o Visual Paradigm, para modelação seguindo a linguaguem de modelação UML), e todas as ferramentas de desenvolvimento, coordenação e teste de código, que foi desenvolvido usando a linguagem de programação Java, usado pela equipa de desenvolvimento (podes mencionar isto sem entrar em muito detalhe sobre quais são). 
		Evita o uso de bullet points se enumerares algo e mantém o estilo de escrita que um Engenheiro de Software teria ao redigir um relatório que falasse sobre isto.
	\end{tcolorbox}
	\par
	\textbf{Avaliação:} ... \par
	\textbf{Modificações:} ... \par
