...
No contexto do desenvolvimento deste projeto, os stakeholders desempenharam um papel essencial na definição dos objetivos, na validação dos requisitos e na garantia de que o sistema final correspondeu às necessidades reais da organização. Os stakeholders foram classificados em duas categorias principais: internos e externos.
...
Os stakeholders externos são todos os intervenientes que, não pertencendo à estrutura interna da organização, influenciaram ou foram impactados pelo desenvolvimento do sistema. No contexto deste projeto, incluíram os clientes, os fornecedores e a equipa de desenvolvimento. A sua importância residiu no fornecimento de feedback, validação de serviços e execução técnica do sistema, assegurando que a solução final fosse funcional, adequada às necessidades do negócio e tecnicamente sólida.
