...
public interface ISStock {
    ...
    void aumentarQuantidadePeca(int idPeca, int n);
    void diminuirQuantidadePeca(int idPeca, int n);
    ...
    void adicionarPecasEncomendaStock(int idEncomenda, List<PecasDoOrcamento> pecas, float preco_compra);
