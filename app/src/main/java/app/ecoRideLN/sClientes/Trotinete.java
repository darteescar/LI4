...
public class Trotinete {
     ...
     public int getNum_serie() { return num_serie; }
     public void setNum_serie(int num_serie) { this.num_serie = num_serie; }
     ...
     public List<Integer> getCodsOrdensServico() { return new ArrayList<>(codsOrdensServico); }
     public void setCodsOrdensServico(List<Integer> codsOrdensServico) { this.codsOrdensServico = new ArrayList<>(codsOrdensServico); }
}
