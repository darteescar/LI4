...
public class Encomenda {
    ...
    public LocalDateTime getData_rececao() { return data_rececao; }
    public void setData_rececao(LocalDateTime data_rececao) { this.data_rececao = data_rececao; }
    ...
    public List<ItemEncomenda> getItensEncomendados() { return new ArrayList<>(itensEncomendados); }
    public void setItensEncomendados(List<ItemEncomenda> itensEncomendados) {
        this.itensEncomendados = new ArrayList<>(itensEncomendados);
    }

    public List<Integer> getCodEntradasStock() { return new ArrayList<>(codEntradasStock); }
    ...
    public List<Stock> getEntradasStock() {
        ...
        for (Integer codEntrada : codEntradasStock) {
            ...
            if (stock != null) entradas.add(stock);
        }
        return entradas;
    }
}
