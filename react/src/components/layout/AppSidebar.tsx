    ...
    <Sidebar collapsible="icon" className="border-r">
      <SidebarHeader className="border-b border-sidebar-border">
        <div className="flex items-center gap-2 px-2 py-2">
          <div className="flex h-9 w-9 items-center justify-center rounded-md bg-white shrink-0 overflow-hidden">
            <img src={logoEcoRide} alt="EcoRide Solutions" className="h-9 w-9 object-cover" />
          </div>
          {!collapsed && (
