...
\begin{document}
	...
	\begin{tabularx}{\textwidth}{@{}|l|X|@{}}
		...
		\textbf{3} & O sistema deverá ter um "Quadro de Estado em Tempo Real" acessível na receção. Sempre que um mecânico atualizar o estado de uma OS, a assistente deve ser sempre sinalizada (para os casos que lhe competem). \\ \hline
	\end{tabularx}
