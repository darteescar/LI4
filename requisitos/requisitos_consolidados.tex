...
\begin{document}
	...
	\begin{tabularx}{\textwidth}{@{}|l|X|@{}}
		...
		\textbf{13}  & O sistema deve permitir registar peças com referência do fornecedor, nome, descrição, marca, preço de venda único por peça, nível mínimo em stock, tempo de garantia e fornecedor, podendo ser marcadas como inativas; e registar entradas de stock com quantidade, preço de compra e data de chegada. \\ \hline
		\textbf{14}  & O sistema deve permitir registar a saída de peças associadas a uma ordem de serviço, identificando apenas a peça e a quantidade utilizadas. \\ \hline
	\end{tabularx}
	\begin{tabularx}{\textwidth}{@{}|l|X|@{}}
		\hline
		\rowcolor{gray!10} \textbf{Número} & \textbf{Descrição} \\ \hline
		...
		\textbf{23} & O sistema deverá calcular os valores dos custos e lucros da oficina e mostrar essa informação na interface do gerente. Deverá ser possível acompanhar os salários, compras de peças, rendas e outras despesas e filtrar por intervalos de tempo. \\ \hline
		\textbf{24} & Quando um mecânico reportar defeito numa peça, o sistema deve bloquear automaticamente todas as entradas de stock dessa peça, preservando o estado anterior de cada uma para eventual restauração após inspeção. \\ \hline
	\end{tabularx}
	...
	\begin{tabularx}{\textwidth}{@{}|l|X|@{}}
		\hline
		\rowcolor{gray!10} \textbf{Número} & \textbf{Descrição} \\ \hline
		\textbf{1} & O sistema deverá ser possível nomear os itens que foram deixados na hora de entrega da trotinete, como por exemplo, carregador, cadeado e chave.  \\ \hline
