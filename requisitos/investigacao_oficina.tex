...
\begin{document}
	...
	\section*{2. Requisitos obtidos}
		...
		\begin{tabularx}{\textwidth}{@{}|l|X|@{}}
			...
			\textbf{5} & O sistema deverá implementar de uma "Data Prevista de Chegada" (ETA) nas encomendas de peças, que irá refletir automaticamente na ordem de serviço associada o atraso, mudando o estado  "A Aguardar Peças (Atrasado)", para que a receção saiba informar o cliente. \\ \hline
