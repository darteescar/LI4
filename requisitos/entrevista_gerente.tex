...
\begin{document}
	...
	\begin{transcription}
		...
		\resposta{Durante a reparação, o mecânico costuma escrever o que fez, mas nem sempre é muito detalhado. Às vezes escreve só troca de pneu ou substituição de travão, outras vezes escreve mais, se for algo fora do normal. E sim, na grande maioria dos casos, as reparações que eles fazem envolvem um conjunto de tarefas muito parecidas.}
		...
		\resposta{Sim, é algo que eu já tinha pensado no passado mas não tinha tido a habilidade de colocar na prática. Se conseguisse implementar isso no sistema seria ótimo. Coloque 1 semana de tolerância e depois disso aplique uma taxa de 3€ por cada dia que passasse (excluindo o dia do levantamento).}
