...
\begin{document}
	...
	\begin{tabularx}{\textwidth}{@{}|l|X|@{}}
		...
		\textbf{8} & Quando um mecânico reportar um defeito numa peça, o sistema deverá automaticamente bloquear todas as entradas de stock dessa peça, colocando-as no estado "Possível Defeito" e impedindo a sua utilização em novas reparações. Para cada entrada bloqueada, o sistema deverá preservar o estado em que se encontrava previamente, de modo a permitir a sua restauração caso a inspeção conclua que não apresenta defeito. O gestor de stock deverá poder, para cada entrada no estado "Possível Defeito", decidir entre destiná-la a devolução ao fornecedor ou repô-la no estado anterior. \\ \hline
	\end{tabularx}
