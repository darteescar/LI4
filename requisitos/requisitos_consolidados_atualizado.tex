...
\begin{document}
	...
	\begin{tabularx}{\textwidth}{@{}|l|X|@{}}
		...
		\textbf{9} & O sistema deve impedir a conclusão de uma OS no estado "Pendente Pagamento"\space caso o cliente referenciado na mesma tenha outras OS no estado "Pendente Pagamento" que tenham tido a confirmação de término de reparação numa data anterior à primeira. \\ \hline
	\end{tabularx}
