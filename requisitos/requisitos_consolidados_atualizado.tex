...
\begin{document}
	...
	\begin{tabularx}{\textwidth}{@{}|l|X|@{}}
		...
		\textbf{7} & O sistema deve permitir registar a aprovação do orçamento somente em OS que estejam no estado "Pendente aprovação do orçamento"\space por parte de um cliente, antes de permitir que o mecânico continue a reparação. Esta aprovação deverá colocar a OS num estado de "Pendente Reparação". \\ \hline
