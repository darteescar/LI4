...
\begin{document}
	...
	\begin{tabularx}{\textwidth}{@{}|l|X|@{}}
		...
		\textbf{5} & O sistema deve permitir registar entradas de peças obrigatoriamente com: referência, quantidade, fornecedor, preço de compra e venda, data de receção, e, quando o preço de compra for superior a 70€, número de série e tempo de garantia. \\ \hline
