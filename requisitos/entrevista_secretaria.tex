...
\begin{document}
	...
	\begin{transcription}
		...
		\resposta{As formas de pagamento mais usadas são numerário, multibanco e MBWay. Cada cliente tem a sua preferência, mas ultimamente o MBWay tem sido muito comum, especialmente entre os mais jovens. Sim, era importante que o sistema registasse qual foi o método usado em cada venda, até para depois sabermos quanto dinheiro deve ter em caixa e no banco.}
