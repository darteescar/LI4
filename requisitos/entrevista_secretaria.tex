...
\begin{document}
	...
	\begin{transcription}
		...
		\resposta{Para contactar o cliente sobre alterações no orçamento, uso quase sempre o telefone ou o WhatsApp. O WhatsApp é o mais rápido porque a maioria das pessoas responde logo e fica tudo registado por escrito. Explico o que o mecânico encontrou e pergunto se o cliente autoriza avançar com o novo valor.}
		...
		\resposta{Quando uma reparação é feita, o mecânico traz-me a ficha com as anotações do que foi feito e das peças que usou. A partir daí, consigo calcular quanto o cliente tem de pagar, somando o tempo de trabalho e o preço das peças. Depois contacto o cliente, outra vez por telefone ou WhatsApp, para avisar que já pode vir buscar a trotinete. Quando o cliente chega, passo a fatura no programa que usamos e finalizo o processo.
}
