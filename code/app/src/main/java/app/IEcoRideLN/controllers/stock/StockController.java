package app.IEcoRideLN.controllers.stock;

import java.util.List;

import app.IEcoRideLN.auth.GestorSessoes;
import app.IEcoRideLN.controllers.ordensservico.dto.DefeitoToDevolucaoRequest;
import app.IEcoRideLN.controllers.stock.dto.DefeitoRequest;
import app.IEcoRideLN.controllers.stock.dto.EncomendaRequest;
import app.IEcoRideLN.controllers.stock.dto.FornecedorRequest;
import app.IEcoRideLN.controllers.stock.dto.PecaRequest;
import app.IEcoRideLN.controllers.stock.dto.SplitDefeitoRequest;
import app.IEcoRideLN.controllers.stock.dto.StockRequest;
...
public class StockController {
    ...
    public StockController(IEcoRideController facade) {
        this.facade = facade;
    }
