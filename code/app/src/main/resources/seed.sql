...
VALUES
    ...
    (7,  'Reparação de Motor Elétrico', 'Desmontagem e reparação básica do motor.',                                           35.00, TRUE),
    (8,  'Substituição de Bateria',     'Instalação e teste de uma nova bateria.',                                            20.00, TRUE),
    (9,  'Reparação de Controlador',    'Reparação ou substituição do controlador eletrónico.',                              25.00, TRUE),
    ...
    (14, 'Troca de Suspensão',          'Substituição e ajuste da suspensão.',                                                22.50, TRUE),
    ...
    (18, 'Substituição de Guarda-Lamas','Troca e fixação de guarda-lamas.',                                                    9.00, TRUE),
    (19, 'Reparação de Cablagem',       'Correção de ligações elétricas danificadas.',                                        18.00, TRUE),
    (20, 'Revisão Completa',            'Revisão geral de segurança e funcionamento.',                                      30.00, TRUE);
