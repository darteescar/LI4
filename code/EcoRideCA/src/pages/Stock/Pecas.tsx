...
const EMPTY: PecaForm = {
  ...
  precoVenda: 0, stockMinimo: 0, disponivel: true,
};
      ...
      <div className="rounded-lg border bg-card shadow-sm">
        <Table>
          ...
          <TableBody>
            {filtered.length === 0 ? (
              <TableRow>
                <TableCell colSpan={canEdit ? 7 : 6} className="h-24 text-center text-sm text-muted-foreground">
        ...
        <div className="grid gap-3 sm:grid-cols-2">
          ...
          <div className="sm:col-span-2">
            <Field label="Disponibilidade">
              <Select value={form.disponivel ? "true" : "false"}
                onValueChange={(v) => set("disponivel", v === "true")}>
                <SelectTrigger><SelectValue /></SelectTrigger>
                <SelectContent>
