...
function seed(): DB {
  ...
  const fornecedores: Fornecedor[] = [
    { id: "f-1", nome: "TrotiPeças Lda", telemovel: "210000001", email: "geral@trotipecas.pt" },
    { id: "f-2", nome: "EletroMobile SA", telemovel: "210000002", email: "vendas@eletromobile.pt" },
  ];

  const pecas: Peca[] = [
    { id: "p-1", referencia: "BAT-36V", nome: "Bateria 36V", descricao: "Bateria de lítio 36V 10Ah", fornecedorId: "f-2", tipo: "Bateria", precoVenda: 180, stockAtual: 5, stockMinimo: 3, disponivel: true },
    { id: "p-2", referencia: "PNEU-8.5", nome: "Pneu 8.5\"", descricao: "Pneu tubeless 8.5 polegadas", fornecedorId: "f-1", tipo: "Pneu", precoVenda: 30, stockAtual: 12, stockMinimo: 6, disponivel: true },
    { id: "p-3", referencia: "TRV-DISC", nome: "Travão de disco", descricao: "Conjunto travão disco", fornecedorId: "f-1", tipo: "Travão", precoVenda: 60, stockAtual: 2, stockMinimo: 4, disponivel: true },
    { id: "p-4", referencia: "MOT-350W", nome: "Motor 350W", descricao: "Motor brushless 350W", fornecedorId: "f-2", tipo: "Motor", precoVenda: 150, stockAtual: 4, stockMinimo: 2, disponivel: true },
    { id: "p-5", referencia: "VIS-LCD", nome: "Visor LCD", descricao: "Visor LCD com botões", fornecedorId: "f-2", tipo: "Eletrónica", precoVenda: 40, stockAtual: 0, stockMinimo: 2, disponivel: false },
  ];

  const reparacoes: Reparacao[] = [
    { id: "r-1", nomenclatura: "Troca de bateria", descricao: "Substituição completa da bateria", preco: 25, disponivel: true },
    { id: "r-2", nomenclatura: "Troca de pneu", descricao: "Substituição de pneu dianteiro/traseiro", preco: 15, disponivel: true },
    { id: "r-3", nomenclatura: "Reparação travões", descricao: "Afinação e troca de calços", preco: 20, disponivel: true },
    { id: "r-4", nomenclatura: "Diagnóstico geral", descricao: "Inspeção completa", preco: 10, disponivel: true },
    { id: "r-5", nomenclatura: "Reparação eletrónica", descricao: "Reparação de placa controladora", preco: 40, disponivel: false },
  ];
